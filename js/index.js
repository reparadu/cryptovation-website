...
const getBXData = (suffix) => {
    return fetch(`https://cors-anywhere.herokuapp.com/https://bx.in.th/api/orderbook/?pairing=${suffix}`);
}
  ...
  .then((data) => {
    ...
    .then((data) => {
      ...
      document.getElementById("KK-CO_BTC_oneWay").innerHTML= 
                  ...
                  ((((((fundAmountKK/buyBTC_KK_fee)- feeWD_BTC_KK ) * sellBTC_CO_fee) - (fundAmountKK * 1124.52)) / (fundAmountKK * 1124.52)) * 100 ).toFixed(2);           

      document.getElementById("KK-CO_ETH_oneWay").innerHTML= 

                  ((((((fundAmountKK/buyETH_KK_fee)- feeWD_ETH_KK ) * sellETH_CO_fee) - (fundAmountKK * 1124.52)) / (fundAmountKK * 1124.52)) * 100 ).toFixed(2);           

      document.getElementById("KK-CO_XRP_oneWay").innerHTML= 

                  ((((((fundAmountKK/buyXRP_KK_fee)- feeWD_XRP_KK ) * sellXRP_CO_fee) - (fundAmountKK * 1124.52)) / (fundAmountKK * 1124.52)) * 100 ).toFixed(2);           

      document.getElementById("KK-CO_ETC_oneWay").innerHTML= 

                  ((((((fundAmountKK/buyETC_KK_fee)- feeWD_ETC_KK ) * sellETC_CO_fee) - (fundAmountKK * 1124.52)) / (fundAmountKK * 1124.52)) * 100 ).toFixed(2);           
      ...
      document.getElementById("CO-PO_BTC_oneWay").innerHTML= 
                  ...
                  ((((((fundAmountCO/buyBTC_CO_fee)- feeWD_BTC_CO ) * sellBTC_PO_fee) - (fundAmountCO * 0.00089)) / (fundAmountCO * 0.00089)) * 100 ).toFixed(2);           

      document.getElementById("CO-PO_ETH_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyETH_CO_fee)- feeWD_ETH_CO ) * sellETH_PO_fee) - (fundAmountCO * 0.00089)) / (fundAmountCO * 0.00089)) * 100 ).toFixed(2);           

      document.getElementById("CO-PO_XRP_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyXRP_CO_fee)- feeWD_XRP_CO ) * sellXRP_PO_fee) - (fundAmountCO * 0.00089)) / (fundAmountCO * 0.00089)) * 100 ).toFixed(2);           

      document.getElementById("CO-PO_ETC_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyETC_CO_fee)- feeWD_ETC_CO ) * sellETC_PO_fee) - (fundAmountCO * 0.00089)) / (fundAmountCO * 0.00089)) * 100 ).toFixed(2);           
...
// // 
      ...
      document.getElementById("CO-KK_BTC_oneWay").innerHTML= 
                  ...
                  ((((((fundAmountCO/buyBTC_CO_fee)- feeWD_BTC_CO ) * sellBTC_KK_fee) - (fundAmountCO * 0.00089)) / (fundAmountCO * 0.00089)) * 100 ).toFixed(2);           

      document.getElementById("CO-KK_ETH_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyETH_CO_fee)- feeWD_ETH_CO ) * sellETH_KK_fee) - (fundAmountCO * 0.00089)) / (fundAmountCO * 0.00089)) * 100 ).toFixed(2);           

      document.getElementById("CO-KK_XRP_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyXRP_CO_fee)- feeWD_XRP_CO ) * sellXRP_KK_fee) - (fundAmountCO * 0.00089)) / (fundAmountCO * 0.00089)) * 100 ).toFixed(2);           

      document.getElementById("CO-KK_ETC_oneWay").innerHTML= 

                  ((((((fundAmountCO/buyETC_CO_fee)- feeWD_ETC_CO ) * sellETC_KK_fee) - (fundAmountCO * 0.00089)) / (fundAmountCO * 0.00089)) * 100 ).toFixed(2);           
      ...
      document.getElementById("PO-CO_BTC_oneWay").innerHTML= 
                  ...
                  ((((((fundAmountPO/buyBTC_PO_fee)- feeWD_BTC_PO ) * sellBTC_CO_fee) - (fundAmountPO * 1124.52)) / (fundAmountPO * 1124.52)) * 100 ).toFixed(2);           

      document.getElementById("PO-CO_ETH_oneWay").innerHTML= 

                  ((((((fundAmountPO/buyETH_PO_fee)- feeWD_ETH_PO ) * sellETH_CO_fee) - (fundAmountPO * 1124.52)) / (fundAmountPO * 1124.52)) * 100 ).toFixed(2);           

      document.getElementById("PO-CO_XRP_oneWay").innerHTML= 

                  ((((((fundAmountPO/buyXRP_PO_fee)- feeWD_XRP_PO ) * sellXRP_CO_fee) - (fundAmountPO * 1124.52)) / (fundAmountPO * 1124.52)) * 100 ).toFixed(2);           

      document.getElementById("PO-CO_ETC_oneWay").innerHTML= 

                  ((((((fundAmountPO/buyETC_PO_fee)- feeWD_ETC_PO ) * sellETC_CO_fee) - (fundAmountPO * 1124.52)) / (fundAmountPO * 1124.52)) * 100 ).toFixed(2);           
